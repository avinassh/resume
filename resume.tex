...
\address{IIIT-Hyderabad}{Gachibowli, Hyderabad - 500032}{India}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
\mobile{+91-801-951-1996}                          % optional, remove / comment the line if not wanted
...
\email{avinashsajjanshetty@gmail.com}                               % optional, remove / comment the line if not wanted
%\homepage{www.johndoe.com}                         % optional, remove / comment the line if not wanted
\extrainfo{\faGithub \href{https://github.com/avinassh}{avinassh}} 
\quote{'If Avinash walked into your office searching for a job, hire him ASAP!' - Former Technical Manager}                                 % optional, remove / comment the line if not wanted
